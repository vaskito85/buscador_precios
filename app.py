...
if st.session_state.session:
    ...
    st.sidebar.caption(f"⏱️ Sesión válida por 24 horas (automática)")
...
if page == "Login":
    ...
    if st.session_state.session and st.session_state.user_email:
        ...
        st.info("⏱️ Tu sesión se mantiene automáticamente durante 24 horas.")
    ...
    if st.button("Validar código"):
        try:
            ...
            st.success("¡Listo! Sesión iniciada (24 horas).")
...
# =========================
    ...
    # Sin value= para permitir edición libre
